...
data = dlmread('/Users/tkarsist/Documents/FreeIMU/freeimu/libraries/FreeIMU/calibration/acc.txt', ' ');
[A_OSx, A_OSy, A_OSz, A_SCx, A_SCy, A_SCz] = Ellipsoid_to_Sphere(data, 'acc');

data = dlmread('/Users/tkarsist/Documents/FreeIMU/freeimu/libraries/FreeIMU/calibration/magn.txt', ' ');
[M_OSx, M_OSy, M_OSz, M_SCx, M_SCy, M_SCz] = Ellipsoid_to_Sphere(data, 'magn');


%storing values to calibration header
calfile = fopen('/Users/tkarsist/Documents/FreeIMU/freeimu/libraries/FreeIMU/calibration/calibration.h', 'w');
